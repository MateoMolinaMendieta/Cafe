<%@ Page Title="" Language="C#" MasterPageFile="~/View/Menu/Menu.Master" AutoEventWireup="true" CodeBehind="BuscarInsumo.aspx.cs" Inherits="Ejemplo.View.Insumo.BuscarInsumo" %>
    ...
    <form runat="server">
        <div class="card">
            <div class="card-header" style="background: #28a745">
                <strong class="card-title">Informacion Insumo</strong>
            </div>
            <div class="card-body">
                            ...
                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="bootstrap-data-table-export_info">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting_asc" tabindex="0" aria-controls="bootstrap-data-table-export" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 209px;">Id Insumo</th>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="bootstrap-data-table-export" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 154px;">Valor</th>
                                ...
                                <tbody>
                                    <asp:ListView runat="server" ID="list_insumo">
                                        <ItemTemplate>
                                            <tr>
                                                <td><%#Eval("IdInsumo")%></td>
                                                <td><%#Eval("Nombre")%> </td>
                                                ...
                                                <td style="width: 300px">
                                                    ...
                                                    <asp:LinkButton Style="color: black" CommandArgument='<%#Eval("IdInsumo")+","+Eval("Nombre")+","+Eval("Descripcion")+","+Eval("Valor")%>' OnCommand="Modificar" runat="server" CommandName="traer"><i class="fa fa-pencil"></i>
