<%@ Page Title="" Language="C#" MasterPageFile="~/View/Menu/Menu.Master" AutoEventWireup="true" CodeBehind="RegistrarC.aspx.cs" Inherits="Ejemplo.View.Cultivo.RegistrarC" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form runat="server">
        <div>
            <asp:Button ID="Button2" CssClass="btn btn-lg social foursquare" Style="margin-bottom: 4px" runat="server" Text="Registrar Cultivo" OnClick="Button2_Click" />
        </div>
        <div class="col-md-12">
                            ...
                            <section class="card">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item text-center" >
                                                ...
                                                CommandArgument='<%#Eval("idCultivo")+","+Eval("Nombre")+","+Eval("descripcion")%>'
            ...
            <div class="modal fade show" id="mediumM" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" style="display: block; padding-left: 0px;">
                <div class="modal-dialog modal-lg" role="document">
                    ...
                    <div class="form-group" s>
                        <label for="nf-email" class=" form-control-label">ID Cultivo</label>
                        <input runat="server" type="text" id="idcultivo" name="nombres" class="form-control col-lg-12">
                    </div>
                    ...
                    <div class="form-group">
                        <label for="nf-password" class=" form-control-label">Descripcion</label>
                        <input runat="server" type="text" id="descripcion" name="ubicaiones" class="form-control col-lg-12">
                    </div>
